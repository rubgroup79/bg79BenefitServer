...
namespace Benefit.Models
{
    public class OnlineHistoryTrainee: OnlineHistory
    {
        ...
        public OnlineHistoryTrainee( int _userCode, DateTime _date, DateTime _time, string _latitude, string _longitude, DateTime _startTime, DateTime _endTime, bool _withTrainer, bool _withPartner, bool _groupWithTrainer , bool _groupWithPartners)
