...
public class DBservices
{
    ...
    public int SignInTrainee(Trainee t)
    {
        ...
        try
        {
            ...
            pStr = BuildInsertTraineeCommand(UserCode, t);
            cmd = CreateCommand(pStr, con);
            return UserCode;
        }
        catch (Exception ex)
    ...
    public bool InsertSportCategories(int[] SportCategories, int UserCode)
    {
        ...
        try
        {
            ...
            {
                String str = BuildInsertSportCategoriesCommand(SportCategories[i], UserCode);
    ...
    private String BuildInsertUserCommand(User u)
    {
        ...
        sb.AppendFormat("Values('{0}','{1}','{2}','{3}','{4}',{5},'{6}',{7},{8})", u.Email, u.FirstName, u.LastName, u.Password, u.Gender, u.DateOfBirth.ToString(), u.Picture, u.SearchRadius.ToString(), u.IsTrainer.ToString());
        String prefix = "INSERT INTO Users (Email, FirstName, LastName, Password, Gender, DateOfBirth, Picture, SearchRadius, IsTrainer) output INSERTED.UserCode ";
    ...
    private String BuildInsertTraineeCommand(int UserCode, Trainee t)
    {
        ...
        sb.AppendFormat("Values({0},{1},{2},{3},{4})", UserCode.ToString(), t.MinBudget.ToString(), t.MaxBudget.ToString(), t.PartnerGender.ToString(), t.TrainerGender.ToString());
        String prefix = "INSERT INTO Users (UserCode, MinBudget, MaxBudget, PartnerGender, TrainerGender ";
        command = prefix + sb.ToString();
        return command;
    }
    ...
    private String BuildInsertTrainerCommand(int UserCode, Trainer t)
    {
        ...
        String prefix = "INSERT INTO Users (UserCode, PersonalTrainingPrice, GroupTrainingPrice ";
        command = prefix + sb.ToString();
        return command;
    }
    ...
    private String BuildInsertSportCategoriesCommand(int UserCode, int CategoryCode)
    {
        ...
        String prefix = "INSERT INTO UserSportCategories (UserCode, CategoryCode) output INSERTED.UserCode ";
        command = prefix + sb.ToString();
        return command;
    }
